...
String randomUsername = generateRandomString(12)
...
WebUI.sendKeys(findTestObject('home/Login/login - username'), randomUsername)

WebUI.sendKeys(findTestObject('home/Login/login - pass'), randomPassword)
...
if (WebUI.waitForAlert(1)) {
    ...
    WebUI.verifyMatch(WebUI.getAlertText(), GlobalVariable.userDoesNotExist, false)
