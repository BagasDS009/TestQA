...
WebUI.click(findTestObject('home/Item on home/Item 1'))

WebUI.verifyMatch(WebUI.getText(findTestObject('home/item when order/Wording item name')), GlobalVariable.titelItem, false)
WebUI.verifyMatch(WebUI.getText(findTestObject('home/item when order/Wording price')), GlobalVariable.priceOrder, false)

WebUI.click(findTestObject('home/Item when order/btn order'))
...
if (WebUI.waitForAlert(2)) {
    ...
    // Verifikasi teks alert sesuai dengan yang diharapkan
    WebUI.verifyMatch(WebUI.getAlertText(), GlobalVariable.productAdd, false)
...
WebUI.click(findTestObject('home/BTN HOME'))

WebUI.verifyElementVisible(findTestObject('Object Repository/home/Kategori/Wording Kategori'))
