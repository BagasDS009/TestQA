...
WebUI.sendKeys(findTestObject('home/Sigin/signin - username'), '1')

WebUI.sendKeys(findTestObject('home/Sigin/signin - pass'), '1')
...
if (WebUI.waitForAlert(2)) {
    ...
    WebUI.verifyMatch(WebUI.getAlertText(), GlobalVariable.validateUserAlreadyExist, false)
