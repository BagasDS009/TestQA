...
String randomUsername = generateRandomString(3)

String randomPassword = generateRandomString(3)
...
if (WebUI.waitForAlert(2)) {
	...
	WebUI.verifyMatch(WebUI.getAlertText(), GlobalVariable.Tidakbolehdibawah8karakter, false)
